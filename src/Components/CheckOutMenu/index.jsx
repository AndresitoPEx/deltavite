...
const CheckOutMenu = () => {
    ...
    return (
        <div>
            <div className={`${context.isCheckOutMenuOpen ? 'active' : ''} overlay`} onClick={() => context.closeCheckOutMenu()}></div>
            <aside className={`${context.isCheckOutMenuOpen ? 'flex' : 'hidden'} checkout-menu bg-gray-200 `}>
                <div className="flex justify-between m-5 items-center border-gray-200 pb-1 px-3 mb-3 sticky top-0">
                ...
                <Divider/>
                <div className="px-3 flex-1 overflow-y-auto overflow-x-hidden scrollbar-hide bg-gray-200">
                ...
                <div className="px-6 mb-10 flex flex-col justify-between border-t-2">
                    <div className="flex justify-between items-center p-5 mb-3">

                        <span className="font-light text-xl">Sub Total: </span>
                        <span className="font-medium text-2xl">S/. {parseFloat(context.total).toFixed(2)}</span>{/* Aqui se muestra el precio total de los productos seleccionados*/}
                    </div>
                    <Link to="/mi-pedido">
                        <button
